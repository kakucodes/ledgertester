...
export class SigningStargateClient extends StargateClient {
  ...
  public async signAndBroadcast(
    ...
    let usedFee: StdFee;
    console.log("sab", { signerAddress, messages, fee, memo });
    ...
    console.log("sab raws/bytes", { txRaw, txBytes });
  ...
  public async sign(
    ...
    console.log("sab about to sign", {
      signerData,
      messages,
      isDirectSigner: isOfflineDirectSigner(this.signer),
    });
  ...
  private async signAmino(
    ...
    console.log("sab amino data", {
      signDoc,
      msgs,
      signMode,
      offlineSigner: this.signer.signAmino.toString(),
    });
    const { signature, signed } = await this.signer
      .signAmino(signerAddress, signDoc)
      .catch((e) => console.log("sab amino failure", e));
    console.log("sab signed", { signature, signed });
    const signedTxBody = {
      messages: messages,
      memo: signed.memo,
    };
